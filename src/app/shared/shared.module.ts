...
@NgModule({
  ...
  providers: [
    ...
    { provide: MAT_DIALOG_DEFAULT_OPTIONS, useValue: { hasBackdrop: false } }, // pour le matdialog
    { provide: MAT_DATE_LOCALE, useValue: 'fr-FR' }, // c'est pour changer le format du date en FR
